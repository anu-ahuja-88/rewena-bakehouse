...
// Utility wrapper — always available. Use for scroll-triggered entrance animations.
// For interactive animations (buttons, hovers, cycling text) use framer-motion directly.
